  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        Padding(padding: EdgeInsets.only(top: 150, left: 44),
            child: Icon(Icons.drive_eta, size: 30.0, color: Colors.grey[100])
        ),
        Padding(padding: EdgeInsets.only(top: 190, left: 44, right: 170),
            child: Text(textTitle, style: TextStyle(
                fontSize: 30, height: 1.5, color: Colors.grey[100]))
        ),
        Padding(padding: EdgeInsets.only(top: 300, left: 44, right: 170),
